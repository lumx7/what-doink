...
void opcontrol() {
    ...
    */
    ...
    pros::Task([] {
        ...
        tomobo::EncoderOdometry testodom(chassis->trackingScales, chassis->tracking_left, chassis->tracking_right);
        testodom.startTask();
    ...
    */
    ...
    //robot::controller->print(1, 1, "Unman ");
    ...
    while (true) {
        ...
        // Inputs
        int32_t joy_left = controller->get_analog(ANALOG_LEFT_Y);
        int32_t joy_right = controller->get_analog(ANALOG_RIGHT_Y);
        ...
        // if (manual_mode){
        //     pros::c::controller_set_text(CONTROLLER_MASTER, 1, 1, "M");
        //     //robot::controller->print(1, 1, "M");
        // }
        // else {
        //     pros::c::controller_set_text(CONTROLLER_MASTER, 1, 1, "X");
        //     ///robot::controller->print(1, 1, "X");
        // }

        // if (brake_mode){
        //     pros::c::controller_set_text(CONTROLLER_MASTER, 1, 9, "B");
        //     //robot::controller->print(1, 9, "B");
        // }
        // else {
        //     pros::c::controller_set_text(CONTROLLER_MASTER, 1, 9, "X");
        //     //robot::controller->print(1, 9, "X");
        // }
        ...
        conveyor->oc_update();
        chassis->oc_update(joy_left, joy_right, brake_mode);
